 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Mute | Ctrl | Alt  | GUI  |Lower |SpFn_L|SpFn_R|Raise | Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_planck_grid(
    ...
    KC_MUTE, KC_LCTL, KC_LALT, KC_LGUI, LOWER, SPACE_FNL, SPACE_FNR, RAISE, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
